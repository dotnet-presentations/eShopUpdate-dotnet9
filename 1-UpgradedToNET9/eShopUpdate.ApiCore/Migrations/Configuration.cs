namespace eShopUpdate.ApiCore.Migrations
{
	using eShopUpdate.Entities;
	using System.Data.Entity.Migrations;
	using System.Linq;

	internal sealed class Configuration : DbMigrationsConfiguration<eShopUpdate.Api.ProductDataContext>
	{
		public Configuration()
		{
			AutomaticMigrationsEnabled = false;
			ContextKey = "eShopUpdate.Api.ProductDataContext";
		}

		protected override void Seed(eShopUpdate.Api.ProductDataContext context)
		{
